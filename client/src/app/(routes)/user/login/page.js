...
export default function Login() {
    ...
    return (
        <div>
            <Navbar></Navbar>
            <main className="flex min-h-screen flex-col items-center gap-2 p-[3rem] w-full">
                <div>
                    <Image src={Logo} className="w-full h-[5rem] bg-[#0f0e17] rounded-lg p-2"></Image>
                </div>
                ...
                <form className="flex flex-col gap-6 text-xl" onSubmit={handleSubmit}>
                    <div className='w-[30rem] flex flex-row border-solid border-[#0f0e17] border-[3px] text-[1.5rem] rounded'>
                        ...
                        <input type="email" required className="outline-none p-2 w-[30rem]" onChange={e => { setValues({ ...values, email: e.target.value }) }} placeholder="E-mail"/>
                    </div>
                    <div className='w-[30rem] flex flex-row border-solid border-[#0f0e17] border-[3px] text-[1.5rem] rounded'>
                        <span className="bg-[#0f0e17] p-4 text-white cursor-default">
                        ...
                        <input type={values.eye ? 'text' : 'password'} required className="outline-none p-2 w-[30rem]" onChange={e => { setValues({ ...values, password: e.target.value }) }} placeholder="Šifra"/>
